...
// Confirmed working: HMAC-SHA256(secret, path + sortedKeyValues)
...
export async function GET(req: NextRequest) {
  ...
  console.log('[OAuth callback] strToSign: path +', sortedStr.replace(code, `${code.slice(0, 6)}...`))
